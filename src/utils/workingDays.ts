 ...
 */
export const calculateWorkingDaysInMonth = (date: Date, workingDaysPerWeek: number = 6): number => {
 ...
 */
export const isWorkingDayForEmployee = (date: Date, workingDaysPerWeek: number = 6): boolean => {
