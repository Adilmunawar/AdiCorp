    ...
    <div className="space-y-6 pb-6">
      ...
      <Tabs defaultValue="chat" className="w-full">
        <TabsList className="grid grid-cols-4 w-full mb-6 bg-white border shadow-sm p-1 h-14 rounded-2xl">
          <TabsTrigger value="chat" className="relative flex flex-col items-center gap-1 data-[state=active]:bg-primary/10 data-[state=active]:text-primary rounded-xl py-1.5 h-full">
